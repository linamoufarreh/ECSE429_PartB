Feature: Add a category
  ...
  Scenario: Normal Flow Acceptance Test
    ...
    When I want to add a category with title "test_session" and description "Test_MindMap_Application"
    Then I should see a category with title "test_session" and description "Test_MindMap_Application"
  ...
  Scenario: Alternate Flow Acceptance Test, category already exists
    ...
    When I want to add a category with title "test session" and description "Test MindMap Application"
    Then I should see 2 categories with title "test session" and description "Test MindMap Application"
